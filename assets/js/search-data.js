...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/cv/MargotMadina_cv.pdf";
          },
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-unpacking-simplified-german",
        ...
        section: 'Socials',
        handler: () => {
          window.open("http://www.linkedin.com/in/margotmadinagonzalez", "_blank");
        },
      },{
      id: 'light-theme',
